      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          ...
          <div className="relative w-full md:w-72">
            ...
            <input
              type="text"
              placeholder="Search skill (e.g. AWS, Splunk, Linux)..."
              value={searchQuery}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredCategories.map((cat) => (
            <div
              key={cat.title}
              className="p-6 rounded-2xl bg-[#111827] border border-slate-800/90 shadow-lg hover:border-cyan-500/40 hover:shadow-cyan-950/20 transition-all duration-300 hover:-translate-y-1 group"
              style={{
                perspective: '1000px'
              }}
            >
              ...
              {/* Skill Items (Clean typography with icons, NO percentage bars) */}

...
export const TRANSLATIONS: Record<Language, Translations> = {
  en: {
    ...
    about: {
      ...
      bioP1: "I am a 3rd-year B.Tech Cyber Security student with a strong interest in Cybersecurity, SOC & Blue Team operations, Cloud Security, Cyber Crime Investigation, and Digital Forensics.",
      bioP2: "I focus on building practical security projects involving AWS security, security monitoring, Linux, networking, DevSecOps, and cybersecurity analysis.",
